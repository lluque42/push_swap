...
/*   Updated: 2024/02/08 21:45:48 by lluque           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/**
 * @file libft_additions.h
 * Set of additional generic functions needed for this project to be added
 * in the future to libft.
*/

#ifndef LIBFT_ADDITIONS_H
# define LIBFT_ADDITIONS_H
# include "libft.h"
 ...
 * offset from head.
 *
 * @details Offset is signed and is interpreted as steps from head in the
 * direction consistent with its sign (positive for next).
 *
